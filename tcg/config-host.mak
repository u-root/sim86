...
libs_softmmu=-lpixman-1  -lutil -lncurses    
ARCH=i386
STRIP=strip
CONFIG_POSIX=y
CONFIG_LINUX=y
...
QEMU_INCLUDES=-I$(SRC_PATH)/tcg -I$(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/rminnich/qemu/linux-headers -I. -I$(SRC_PATH) -I$(SRC_PATH)/include
AUTOCONF_HOST := 
