...
****************************************************************************/
func x86emuOp_prefix_data(u8 _) {
    START_OF_INSTR();
    DECODE_PRINTF("DATA:\n");
    TRACE_AND_STEP();
...
****************************************************************************/
func x86emuOp_prefix_addr(u8 _) {
    START_OF_INSTR();
    DECODE_PRINTF("ADDR:\n");
    TRACE_AND_STEP();
...
Handles opcode 0x68
****************************************************************************/
func x86emuOp_push_word_IMM(u8 _) {
    u32 imm;
...
Handles opcode 0x69
****************************************************************************/
func x86emuOp_imul_word_IMM(u8 _) {
    int mod, rl, rh;
    uint srcoffset;
...
Handles opcode 0x6a
****************************************************************************/
func x86emuOp_push_byte_IMM(u8 _) {
    s16 imm;
...
Handles opcode 0x6b
****************************************************************************/
func x86emuOp_imul_byte_IMM(u8 _) {
    int mod, rl, rh;
    uint srcoffset;
    s8 imm;
...
Handles opcode 0x80
****************************************************************************/
func x86emuOp_opc80_byte_RM_IMM(u8 _) {
    int mod, rl, rh;
    u8 *destreg;
    uint destoffset;
    u8 imm;
...
Handles opcode 0x81
****************************************************************************/
func x86emuOp_opc81_word_RM_IMM(u8 _) {
    int mod, rl, rh;
    uint destoffset;
...
Handles opcode 0x82
****************************************************************************/
func x86emuOp_opc82_byte_RM_IMM(u8 _) {
    int mod, rl, rh;
    u8 *destreg;
    uint destoffset;
    u8 imm;
...
Handles opcode 0x83
****************************************************************************/
func x86emuOp_opc83_word_RM_IMM(u8 _) {
    int mod, rl, rh;
    uint destoffset;
...
Handles opcode 0x84
****************************************************************************/
func x86emuOp_test_byte_RM_R(u8 _) {
    int mod, rl, rh;
    u8 *destreg, *srcreg;
    uint destoffset;
    u8 destval;
...
Handles opcode 0x85
****************************************************************************/
func x86emuOp_test_word_RM_R(u8 _) {
    int mod, rl, rh;
    uint destoffset;
...
Handles opcode 0x86
****************************************************************************/
func x86emuOp_xchg_byte_RM_R(u8 _) {
    int mod, rl, rh;
    u8 *destreg, *srcreg;
    uint destoffset;
    u8 destval;
...
Handles opcode 0x87
****************************************************************************/
func x86emuOp_xchg_word_RM_R(u8 _) {
    int mod, rl, rh;
    uint destoffset;
...
Handles opcode 0x88
****************************************************************************/
func x86emuOp_mov_byte_RM_R(u8 _) {
    int mod, rl, rh;
    u8 *destreg, *srcreg;
    uint destoffset;
...
Handles opcode 0x89
****************************************************************************/
func x86emuOp_mov_word_RM_R(u8 _) {
    int mod, rl, rh;
    uint destoffset;
...
Handles opcode 0x8a
****************************************************************************/
func x86emuOp_mov_byte_R_RM(u8 _) {
    int mod, rl, rh;
    u8 *destreg, *srcreg;
    uint srcoffset;
    u8 srcval;
...
Handles opcode 0x8b
****************************************************************************/
func x86emuOp_mov_word_R_RM(u8 _) {
    int mod, rl, rh;
    uint srcoffset;
...
Handles opcode 0x8c
****************************************************************************/
func x86emuOp_mov_word_RM_SR(u8 _) {
    int mod, rl, rh;
    u16 *destreg, *srcreg;
    uint destoffset;
    u16 destval;
...
Handles opcode 0x8d
****************************************************************************/
func x86emuOp_lea_word_R_M(u8 _) {
    int mod, rl, rh;
    uint destoffset;
...
Handles opcode 0x8e
****************************************************************************/
func x86emuOp_mov_word_SR_RM(u8 _) {
    int mod, rl, rh;
    u16 *destreg, *srcreg;
    uint srcoffset;
    u16 srcval;
...
****************************************************************************/
func x86emuOp_xchg_word_AX_register(u8 _) {
    u32 tmp;
...
Handles opcode 0x9a
****************************************************************************/
func x86emuOp_call_far_IMM(u8 _) {
    u32 farseg, faroff;
...
Handles opcode 0xa0
****************************************************************************/
func x86emuOp_mov_AL_M_IMM(u8 _) {
    u16 offset;
...
Handles opcode 0xa1
****************************************************************************/
func x86emuOp_mov_AX_M_IMM(u8 _) {
    u16 offset;
...
Handles opcode 0xa2
****************************************************************************/
func x86emuOp_mov_M_AL_IMM(u8 _) {
    u16 offset;
...
Handles opcode 0xa3
****************************************************************************/
func x86emuOp_mov_M_AX_IMM(u8 _) {
    u16 offset;
...
Handles opcode 0xa8
****************************************************************************/
func x86emuOp_test_AL_IMM(u8 _) {
    int imm;
...
Handles opcode 0xa9
****************************************************************************/
func x86emuOp_test_AX_IMM(u8 _) {
    u32 srcval;
...
****************************************************************************/
func x86emuOp_mov_word_register_IMM(u8 _) {
    u32 srcval;
...
Handles opcode 0xc0
****************************************************************************/
func x86emuOp_opcC0_byte_RM_MEM(u8 _) {
    int mod, rl, rh;
    u8 *destreg;
    uint destoffset;
    u8 destval;
...
Handles opcode 0xc1
****************************************************************************/
func x86emuOp_opcC1_word_RM_MEM(u8 _) {
    int mod, rl, rh;
    uint destoffset;
    u8 amt;
...
Handles opcode 0xc2
****************************************************************************/
func x86emuOp_ret_near_IMM(u8 _) {
    u16 imm;
...
Handles opcode 0xc6
****************************************************************************/
func x86emuOp_mov_byte_RM_IMM(u8 _) {
    int mod, rl, rh;
    u8 *destreg;
    uint destoffset;
    u8 imm;
...
Handles opcode 0xc7
****************************************************************************/
func x86emuOp_mov_word_RM_IMM(u8 _) {
    int mod, rl, rh;
    uint destoffset;
...
Handles opcode 0xca
****************************************************************************/
func x86emuOp_ret_far_IMM(u8 _) {
    u16 imm;
...
Handles opcode 0xd0
****************************************************************************/
func x86emuOp_opcD0_byte_RM_1(u8 _) {
    int mod, rl, rh;
    u8 *destreg;
    uint destoffset;
    u8 destval;
...
Handles opcode 0xd1
****************************************************************************/
func x86emuOp_opcD1_word_RM_1(u8 _) {
    int mod, rl, rh;
    uint destoffset;
...
Handles opcode 0xd2
****************************************************************************/
func x86emuOp_opcD2_byte_RM_CL(u8 _) {
    int mod, rl, rh;
    u8 *destreg;
    uint destoffset;
    u8 destval;
...
Handles opcode 0xd3
****************************************************************************/
func x86emuOp_opcD3_word_RM_CL(u8 _) {
    int mod, rl, rh;
    uint destoffset;
    u8 amt;
...
Handles opcode 0xe4
****************************************************************************/
func x86emuOp_in_byte_AL_IMM(u8 _) {
    u8 port;
...
Handles opcode 0xe5
****************************************************************************/
func x86emuOp_in_word_AX_IMM(u8 _) {
    u8 port;
...
Handles opcode 0xe6
****************************************************************************/
func x86emuOp_out_byte_IMM_AL(u8 _) {
    u8 port;
...
Handles opcode 0xe7
****************************************************************************/
func x86emuOp_out_word_IMM_AX(u8 _) {
    u8 port;
...
Handles opcode 0xe8
****************************************************************************/
func x86emuOp_call_near_IMM(u8 _) {
...
Handles opcode 0xe9
****************************************************************************/
func x86emuOp_jump_near_IMM(u8 _) {
    u32 ip;
...
Handles opcode 0xea
****************************************************************************/
func x86emuOp_jump_far_IMM(u8 _) {
    u16 cs;
    u32 ip;
...
Handles opcode 0xeb
****************************************************************************/
func x86emuOp_jump_byte_IMM(u8 _) {
    u16 target;
    s8 offset;
...
Handles opcode 0xec
****************************************************************************/
func x86emuOp_in_byte_AL_DX(u8 _) {
    START_OF_INSTR();
...
Handles opcode 0xed
****************************************************************************/
func x86emuOp_in_word_AX_DX(u8 _) {
    START_OF_INSTR();
    if (M.x86.mode & SYSMODE_PREFIX_DATA) {
...
Handles opcode 0xee
****************************************************************************/
func x86emuOp_out_byte_DX_AL(u8 _) {
    START_OF_INSTR();
...
Handles opcode 0xef
****************************************************************************/
func x86emuOp_out_word_DX_AX(u8 _) {
    START_OF_INSTR();
    if (M.x86.mode & SYSMODE_PREFIX_DATA) {
...
Handles opcode 0xf6
****************************************************************************/
func x86emuOp_opcF6_byte_RM(u8 _) {
    int mod, rl, rh;
    u8 *destreg;
    uint destoffset;
    u8 destval, srcval;
...
Handles opcode 0xf7
****************************************************************************/
func x86emuOp_opcF7_word_RM(u8 _) {
    int mod, rl, rh;
    uint destoffset;
...
Handles opcode 0xfe
****************************************************************************/
func x86emuOp_opcFE_byte_RM(u8 _) {
    int mod, rh, rl;
    u8 destval;
    uint destoffset;
    u8 *destreg;
...
Handles opcode 0xff
****************************************************************************/
func x86emuOp_opcFF_word_RM(u8 _) {
    int mod, rh, rl;
    uint destoffset = 0;
 u16 *destreg;
 u32 *destreg32;
