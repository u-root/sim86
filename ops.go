...
Handles opcode 0x06
****************************************************************************/
static void x86emuOp_push_ES(u8 _) {
    START_OF_INSTR();
...
Handles opcode 0x07
****************************************************************************/
static void x86emuOp_pop_ES(u8 _) {
    START_OF_INSTR();
...
Handles opcode 0x0e
****************************************************************************/
static void x86emuOp_push_CS(u8 _) {
    START_OF_INSTR();
...
****************************************************************************/
static void x86emuOp_two_byte(u8 _) {
...
Handles opcode 0x16
****************************************************************************/
static void x86emuOp_push_SS(u8 _) {
    START_OF_INSTR();
...
Handles opcode 0x17
****************************************************************************/
static void x86emuOp_pop_SS(u8 _) {
    START_OF_INSTR();
...
Handles opcode 0x1e
****************************************************************************/
static void x86emuOp_push_DS(u8 _) {
    START_OF_INSTR();
...
Handles opcode 0x1f
****************************************************************************/
static void x86emuOp_pop_DS(u8 _) {
    START_OF_INSTR();
...
Handles opcode 0x26
****************************************************************************/
static void x86emuOp_segovr_ES(u8 _) {
    START_OF_INSTR();
    DECODE_PRINTF("ES:\n");
    TRACE_AND_STEP();
...
Handles opcode 0x2e
****************************************************************************/
static void x86emuOp_segovr_CS(u8 _) {
    START_OF_INSTR();
    DECODE_PRINTF("CS:\n");
    TRACE_AND_STEP();
...
Handles opcode 0x36
****************************************************************************/
static void x86emuOp_segovr_SS(u8 _) {
    START_OF_INSTR();
    DECODE_PRINTF("SS:\n");
    TRACE_AND_STEP();
...
Handles opcode 0x3e
****************************************************************************/
static void x86emuOp_segovr_DS(u8 _) {
    START_OF_INSTR();
    DECODE_PRINTF("DS:\n");
    TRACE_AND_STEP();
...
Handles opcode 0x60
****************************************************************************/
static void x86emuOp_push_all(u8 _) {
    START_OF_INSTR();
    if (M.x86.mode & SYSMODE_PREFIX_DATA) {
...
Handles opcode 0x61
****************************************************************************/
static void x86emuOp_pop_all(u8 _) {
    START_OF_INSTR();
    if (M.x86.mode & SYSMODE_PREFIX_DATA) {
        DECODE_PRINTF("POPAD\n");
    } else {
...
Handles opcode 0x64
****************************************************************************/
static void x86emuOp_segovr_FS(u8 _) {
    START_OF_INSTR();
    DECODE_PRINTF("FS:\n");
    TRACE_AND_STEP();
...
Handles opcode 0x65
****************************************************************************/
static void x86emuOp_segovr_GS(u8 _) {
    START_OF_INSTR();
    DECODE_PRINTF("GS:\n");
    TRACE_AND_STEP();
...
****************************************************************************/
static void x86emuOp_prefix_data(u8 _) {
    START_OF_INSTR();
    DECODE_PRINTF("DATA:\n");
    TRACE_AND_STEP();
...
****************************************************************************/
static void x86emuOp_prefix_addr(u8 _) {
    START_OF_INSTR();
    DECODE_PRINTF("ADDR:\n");
    TRACE_AND_STEP();
...
Handles opcode 0x68
****************************************************************************/
static void x86emuOp_push_word_IMM(u8 _) {
    u32 imm;
...
Handles opcode 0x69
****************************************************************************/
static void x86emuOp_imul_word_IMM(u8 _) {
    int mod, rl, rh;
    uint srcoffset;
...
Handles opcode 0x6a
****************************************************************************/
static void x86emuOp_push_byte_IMM(u8 _) {
    s16 imm;
...
Handles opcode 0x6b
****************************************************************************/
static void x86emuOp_imul_byte_IMM(u8 _) {
    int mod, rl, rh;
    uint srcoffset;
    s8 imm;
...
Handles opcode 0x6c
****************************************************************************/
static void x86emuOp_ins_byte(u8 _) {
    START_OF_INSTR();
    DECODE_PRINTF("INSB\n");
    ins(1);
    TRACE_AND_STEP();
...
Handles opcode 0x6d
****************************************************************************/
static void x86emuOp_ins_word(u8 _) {
    START_OF_INSTR();
    if (M.x86.mode & SYSMODE_PREFIX_DATA) {
        DECODE_PRINTF("INSD\n");
        ins(4);
...
Handles opcode 0x6e
****************************************************************************/
static void x86emuOp_outs_byte(u8 _) {
    START_OF_INSTR();
    DECODE_PRINTF("OUTSB\n");
    outs(1);
    TRACE_AND_STEP();
...
Handles opcode 0x6f
****************************************************************************/
static void x86emuOp_outs_word(u8 _) {
    START_OF_INSTR();
    if (M.x86.mode & SYSMODE_PREFIX_DATA) {
        DECODE_PRINTF("OUTSD\n");
        outs(4);
...
Handles opcode 0x80
****************************************************************************/
static void x86emuOp_opc80_byte_RM_IMM(u8 _) {
    int mod, rl, rh;
    u8 *destreg;
    uint destoffset;
    u8 imm;
...
Handles opcode 0x81
****************************************************************************/
static void x86emuOp_opc81_word_RM_IMM(u8 _) {
    int mod, rl, rh;
    uint destoffset;
...
Handles opcode 0x82
****************************************************************************/
static void x86emuOp_opc82_byte_RM_IMM(u8 _) {
    int mod, rl, rh;
    u8 *destreg;
    uint destoffset;
    u8 imm;
...
Handles opcode 0x83
****************************************************************************/
static void x86emuOp_opc83_word_RM_IMM(u8 _) {
    int mod, rl, rh;
    uint destoffset;
...
Handles opcode 0x84
****************************************************************************/
static void x86emuOp_test_byte_RM_R(u8 _) {
    int mod, rl, rh;
    u8 *destreg, *srcreg;
    uint destoffset;
    u8 destval;
...
Handles opcode 0x85
****************************************************************************/
static void x86emuOp_test_word_RM_R(u8 _) {
    int mod, rl, rh;
    uint destoffset;
...
Handles opcode 0x86
****************************************************************************/
static void x86emuOp_xchg_byte_RM_R(u8 _) {
    int mod, rl, rh;
    u8 *destreg, *srcreg;
    uint destoffset;
    u8 destval;
...
Handles opcode 0x87
****************************************************************************/
static void x86emuOp_xchg_word_RM_R(u8 _) {
    int mod, rl, rh;
    uint destoffset;
...
Handles opcode 0x88
****************************************************************************/
static void x86emuOp_mov_byte_RM_R(u8 _) {
    int mod, rl, rh;
    u8 *destreg, *srcreg;
    uint destoffset;
...
Handles opcode 0x89
****************************************************************************/
static void x86emuOp_mov_word_RM_R(u8 _) {
    int mod, rl, rh;
    uint destoffset;
...
Handles opcode 0x8a
****************************************************************************/
static void x86emuOp_mov_byte_R_RM(u8 _) {
    int mod, rl, rh;
    u8 *destreg, *srcreg;
    uint srcoffset;
    u8 srcval;
...
Handles opcode 0x8b
****************************************************************************/
static void x86emuOp_mov_word_R_RM(u8 _) {
    int mod, rl, rh;
    uint srcoffset;
...
Handles opcode 0x8c
****************************************************************************/
static void x86emuOp_mov_word_RM_SR(u8 _) {
    int mod, rl, rh;
    u16 *destreg, *srcreg;
    uint destoffset;
    u16 destval;
...
Handles opcode 0x8d
****************************************************************************/
static void x86emuOp_lea_word_R_M(u8 _) {
    int mod, rl, rh;
    uint destoffset;
...
Handles opcode 0x8e
****************************************************************************/
static void x86emuOp_mov_word_SR_RM(u8 _) {
    int mod, rl, rh;
    u16 *destreg, *srcreg;
    uint srcoffset;
    u16 srcval;
...
Handles opcode 0x8f
****************************************************************************/
static void x86emuOp_pop_RM(u8 _) {
    int mod, rl, rh;
    uint destoffset;
...
****************************************************************************/
static void x86emuOp_xchg_word_AX_register(u8 _) {
    u32 tmp;
...
Handles opcode 0x9a
****************************************************************************/
static void x86emuOp_call_far_IMM(u8 _) {
    u32 farseg, faroff;
...
Handles opcode 0x9b
****************************************************************************/
static void x86emuOp_wait(u8 _) {
    START_OF_INSTR();
    DECODE_PRINTF("WAIT");
    TRACE_AND_STEP();
    /* NADA.  */
...
Handles opcode 0x9c
****************************************************************************/
static void x86emuOp_pushf_word(u8 _) {
    u32 flags;
...
Handles opcode 0x9d
****************************************************************************/
static void x86emuOp_popf_word(u8 _) {
    START_OF_INSTR();
    if (M.x86.mode & SYSMODE_PREFIX_DATA) {
        DECODE_PRINTF("POPFD\n");
    } else {
...
Handles opcode 0x9e
****************************************************************************/
static void x86emuOp_sahf(u8 _) {
    START_OF_INSTR();
    DECODE_PRINTF("SAHF\n");
    TRACE_AND_STEP();
...
Handles opcode 0x9f
****************************************************************************/
static void x86emuOp_lahf(u8 _) {
    START_OF_INSTR();
    DECODE_PRINTF("LAHF\n");
    TRACE_AND_STEP();
...
Handles opcode 0xa0
****************************************************************************/
static void x86emuOp_mov_AL_M_IMM(u8 _) {
    u16 offset;
...
Handles opcode 0xa1
****************************************************************************/
static void x86emuOp_mov_AX_M_IMM(u8 _) {
    u16 offset;
...
Handles opcode 0xa2
****************************************************************************/
static void x86emuOp_mov_M_AL_IMM(u8 _) {
    u16 offset;
...
Handles opcode 0xa3
****************************************************************************/
static void x86emuOp_mov_M_AX_IMM(u8 _) {
    u16 offset;
...
Handles opcode 0xa4
****************************************************************************/
static void x86emuOp_movs_byte(u8 _) {
    u8 val;
    u32 count;
    int inc;
...
Handles opcode 0xa5
****************************************************************************/
static void x86emuOp_movs_word(u8 _) {
    u32 val;
    int inc;
    u32 count;
...
Handles opcode 0xa6
****************************************************************************/
static void x86emuOp_cmps_byte(u8 _) {
    s8 val1, val2;
    int inc;
...
Handles opcode 0xa7
****************************************************************************/
static void x86emuOp_cmps_word(u8 _) {
    u32 val1,val2;
    int inc;
...
Handles opcode 0xa8
****************************************************************************/
static void x86emuOp_test_AL_IMM(u8 _) {
    int imm;
...
Handles opcode 0xa9
****************************************************************************/
static void x86emuOp_test_AX_IMM(u8 _) {
    u32 srcval;
...
Handles opcode 0xaa
****************************************************************************/
static void x86emuOp_stos_byte(u8 _) {
    int inc;
...
Handles opcode 0xab
****************************************************************************/
static void x86emuOp_stos_word(u8 _) {
    int inc;
    u32 count;
...
Handles opcode 0xac
****************************************************************************/
static void x86emuOp_lods_byte(u8 _) {
    int inc;
...
Handles opcode 0xad
****************************************************************************/
static void x86emuOp_lods_word(u8 _) {
    int inc;
    u32 count;
...
Handles opcode 0xae
****************************************************************************/
static void x86emuOp_scas_byte(u8 _) {
    s8 val2;
    int inc;
...
Handles opcode 0xaf
****************************************************************************/
static void x86emuOp_scas_word(u8 _) {
    int inc;
    u32 val;
...
****************************************************************************/
static void x86emuOp_mov_word_register_IMM(u8 _) {
    u32 srcval;
...
Handles opcode 0xc0
****************************************************************************/
static void x86emuOp_opcC0_byte_RM_MEM(u8 _) {
    int mod, rl, rh;
    u8 *destreg;
    uint destoffset;
    u8 destval;
...
Handles opcode 0xc1
****************************************************************************/
static void x86emuOp_opcC1_word_RM_MEM(u8 _) {
    int mod, rl, rh;
    uint destoffset;
    u8 amt;
...
Handles opcode 0xc2
****************************************************************************/
static void x86emuOp_ret_near_IMM(u8 _) {
    u16 imm;
...
Handles opcode 0xc3
****************************************************************************/
static void x86emuOp_ret_near(u8 _) {
    START_OF_INSTR();
    DECODE_PRINTF("RET\n");
 TRACE_AND_STEP();
    M.x86.R_IP = pop_word();
...
Handles opcode 0xc4
****************************************************************************/
static void x86emuOp_les_R_IMM(u8 _) {
    int mod, rh, rl;
    u16 *dstreg;
    uint srcoffset;
...
Handles opcode 0xc5
****************************************************************************/
static void x86emuOp_lds_R_IMM(u8 _) {
    int mod, rh, rl;
    u16 *dstreg;
    uint srcoffset;
...
Handles opcode 0xc6
****************************************************************************/
static void x86emuOp_mov_byte_RM_IMM(u8 _) {
    int mod, rl, rh;
    u8 *destreg;
    uint destoffset;
    u8 imm;
...
Handles opcode 0xc7
****************************************************************************/
static void x86emuOp_mov_word_RM_IMM(u8 _) {
    int mod, rl, rh;
    uint destoffset;
...
Handles opcode 0xc8
****************************************************************************/
static void x86emuOp_enter(u8 _) {
...
Handles opcode 0xc9
****************************************************************************/
static void x86emuOp_leave(u8 _) {
    START_OF_INSTR();
    DECODE_PRINTF("LEAVE\n");
    TRACE_AND_STEP();
...
Handles opcode 0xca
****************************************************************************/
static void x86emuOp_ret_far_IMM(u8 _) {
    u16 imm;
...
Handles opcode 0xcb
****************************************************************************/
static void x86emuOp_ret_far(u8 _) {
    START_OF_INSTR();
    DECODE_PRINTF("RETF\n");
 TRACE_AND_STEP();
    M.x86.R_IP = pop_word();
...
Handles opcode 0xcc
****************************************************************************/
static void x86emuOp_int3(u8 _) {
    u16 _;
...
Handles opcode 0xcd
****************************************************************************/
static void x86emuOp_int_IMM(u8 _) {
    u16 _;
    u8 intnum;
...
Handles opcode 0xce
****************************************************************************/
static void x86emuOp_into(u8 _) {
    u16 _;
...
Handles opcode 0xcf
****************************************************************************/
static void x86emuOp_iret(u8 _) {
    START_OF_INSTR();
    DECODE_PRINTF("IRET\n");
...
Handles opcode 0xd0
****************************************************************************/
static void x86emuOp_opcD0_byte_RM_1(u8 _) {
    int mod, rl, rh;
    u8 *destreg;
    uint destoffset;
    u8 destval;
...
Handles opcode 0xd1
****************************************************************************/
static void x86emuOp_opcD1_word_RM_1(u8 _) {
    int mod, rl, rh;
    uint destoffset;
...
Handles opcode 0xd2
****************************************************************************/
static void x86emuOp_opcD2_byte_RM_CL(u8 _) {
    int mod, rl, rh;
    u8 *destreg;
    uint destoffset;
    u8 destval;
...
Handles opcode 0xd3
****************************************************************************/
static void x86emuOp_opcD3_word_RM_CL(u8 _) {
    int mod, rl, rh;
    uint destoffset;
    u8 amt;
...
Handles opcode 0xd7
****************************************************************************/
static void x86emuOp_xlat(u8 _) {
    u16 addr;
...
Handles opcode 0xe0
****************************************************************************/
static void x86emuOp_loopne(u8 _) {
    s16 ip;
...
Handles opcode 0xe1
****************************************************************************/
static void x86emuOp_loope(u8 _) {
    s16 ip;
...
Handles opcode 0xe2
****************************************************************************/
static void x86emuOp_loop(u8 _) {
    s16 ip;
...
Handles opcode 0xe3
****************************************************************************/
static void x86emuOp_jcxz(u8 _) {
    u16 target;
    s8 offset;
...
Handles opcode 0xe4
****************************************************************************/
static void x86emuOp_in_byte_AL_IMM(u8 _) {
    u8 port;
...
Handles opcode 0xe5
****************************************************************************/
static void x86emuOp_in_word_AX_IMM(u8 _) {
    u8 port;
...
Handles opcode 0xe6
****************************************************************************/
static void x86emuOp_out_byte_IMM_AL(u8 _) {
    u8 port;
...
Handles opcode 0xe7
****************************************************************************/
static void x86emuOp_out_word_IMM_AX(u8 _) {
    u8 port;
...
Handles opcode 0xe8
****************************************************************************/
static void x86emuOp_call_near_IMM(u8 _) {
...
Handles opcode 0xe9
****************************************************************************/
static void x86emuOp_jump_near_IMM(u8 _) {
    u32 ip;
...
Handles opcode 0xea
****************************************************************************/
static void x86emuOp_jump_far_IMM(u8 _) {
    u16 cs;
    u32 ip;
...
Handles opcode 0xeb
****************************************************************************/
static void x86emuOp_jump_byte_IMM(u8 _) {
    u16 target;
    s8 offset;
...
Handles opcode 0xec
****************************************************************************/
static void x86emuOp_in_byte_AL_DX(u8 _) {
    START_OF_INSTR();
...
Handles opcode 0xed
****************************************************************************/
static void x86emuOp_in_word_AX_DX(u8 _) {
    START_OF_INSTR();
    if (M.x86.mode & SYSMODE_PREFIX_DATA) {
...
Handles opcode 0xee
****************************************************************************/
static void x86emuOp_out_byte_DX_AL(u8 _) {
    START_OF_INSTR();
...
Handles opcode 0xef
****************************************************************************/
static void x86emuOp_out_word_DX_AX(u8 _) {
    START_OF_INSTR();
    if (M.x86.mode & SYSMODE_PREFIX_DATA) {
...
Handles opcode 0xf0
****************************************************************************/
static void x86emuOp_lock(u8 _) {
    START_OF_INSTR();
    DECODE_PRINTF("LOCK:\n");
    TRACE_AND_STEP();
    DECODE_CLEAR_SEGOVR();
...
Handles opcode 0xf2
****************************************************************************/
static void x86emuOp_repne(u8 _) {
    START_OF_INSTR();
    DECODE_PRINTF("REPNE\n");
    TRACE_AND_STEP();
    M.x86.mode |= SYSMODE_PREFIX_REPNE;
...
Handles opcode 0xf3
****************************************************************************/
static void x86emuOp_repe(u8 _) {
    START_OF_INSTR();
    DECODE_PRINTF("REPE\n");
    TRACE_AND_STEP();
    M.x86.mode |= SYSMODE_PREFIX_REPE;
...
Handles opcode 0xf4
****************************************************************************/
static void x86emuOp_halt(u8 _) {
    START_OF_INSTR();
    DECODE_PRINTF("HALT\n");
    TRACE_AND_STEP();
    HALT_SYS();
...
Handles opcode 0xf6
****************************************************************************/
static void x86emuOp_opcF6_byte_RM(u8 _) {
    int mod, rl, rh;
    u8 *destreg;
    uint destoffset;
    u8 destval, srcval;
...
Handles opcode 0xf7
****************************************************************************/
static void x86emuOp_opcF7_word_RM(u8 _) {
    int mod, rl, rh;
    uint destoffset;
...
Handles opcode 0xfe
****************************************************************************/
static void x86emuOp_opcFE_byte_RM(u8 _) {
    int mod, rh, rl;
    u8 destval;
    uint destoffset;
    u8 *destreg;
...
Handles opcode 0xff
****************************************************************************/
static void x86emuOp_opcFF_word_RM(u8 _) {
    int mod, rh, rl;
    uint destoffset = 0;
 u16 *destreg;
 u32 *destreg32;
